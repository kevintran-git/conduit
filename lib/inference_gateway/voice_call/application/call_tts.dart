...
enum TtsStage { idle, connecting, waiting, playing, drained, stopped, error }
...
class CallTts {
  ...
  final ik.ElevenLabsTtsClient client;
  ...
  Future<void> awaitDrain() async {
    ...
    if (_status.stage != TtsStage.stopped && _status.stage != TtsStage.error) {
